...
void setUp(void) { sched = create_priority_scheduler(); }
...
void test_higher_priority_first(void) {
  ...
  p1.id = 1;
  p1.priority = 10;
  p1.ready_queue_arrival_time = 0;
  Process p2;
  p2.id = 2;
  p2.priority = 5;
  p2.ready_queue_arrival_time = 1;
  Process p3;
  p3.id = 3;
  p3.priority = 20;
  p3.ready_queue_arrival_time = 2;
...
void test_tie_breaker_arrival_time(void) {
  ...
  p1.id = 1;
  p1.priority = 10;
  p1.ready_queue_arrival_time = 5;
  Process p2;
  p2.id = 2;
  p2.priority = 10;
  p2.ready_queue_arrival_time = 2;
